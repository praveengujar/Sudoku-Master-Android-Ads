...
import com.sudokumaster.android.di.AppModule_ProvideApiServiceFactory;
import com.sudokumaster.android.di.AppModule_ProvideAuthInterceptorFactory;
import com.sudokumaster.android.di.AppModule_ProvideAuthRepositoryFactory;
import com.sudokumaster.android.di.AppModule_ProvideAuthTokenStorageFactory;
import com.sudokumaster.android.di.AppModule_ProvideGsonFactory;
import com.sudokumaster.android.di.AppModule_ProvideNetworkMonitorFactory;
import com.sudokumaster.android.di.AppModule_ProvideOkHttpClientFactory;
import com.sudokumaster.android.di.AppModule_ProvidePerformanceMonitorFactory;
import com.sudokumaster.android.di.AppModule_ProvideRetrofitFactory;
import com.sudokumaster.android.di.AppModule_ProvideSudokuDatabaseFactory;
import com.sudokumaster.android.di.AppModule_ProvideSudokuRepositoryFactory;
...
import com.sudokumaster.android.presentation.MainActivity;
...
public final class DaggerSudokuApplication_HiltComponents_SingletonC {
  private DaggerSudokuApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public SudokuApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements SudokuApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public SudokuApplication_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements SudokuApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements SudokuApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements SudokuApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements SudokuApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements SudokuApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements SudokuApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SudokuApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends SudokuApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends SudokuApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends SudokuApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends SudokuApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_sudokumaster_android_presentation_viewmodel_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_sudokumaster_android_presentation_viewmodel_SudokuGameViewModel, SudokuGameViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends SudokuApplication_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private Provider<SudokuGameViewModel> sudokuGameViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.sudokuGameViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_sudokumaster_android_presentation_viewmodel_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_sudokumaster_android_presentation_viewmodel_SudokuGameViewModel, ((Provider) sudokuGameViewModelProvider)).build());
    }
  ...
  private static final class ActivityRetainedCImpl extends SudokuApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends SudokuApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends SudokuApplication_HiltComponents.SingletonC {
    ...
    private Provider<SudokuDatabase> provideSudokuDatabaseProvider;
    ...
    @Override
    public void injectSudokuApplication(SudokuApplication sudokuApplication) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.sudokumaster.android.domain.repository.AuthRepository 
          return (T) AppModule_ProvideAuthRepositoryFactory.provideAuthRepository(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.provideAuthTokenStorageProvider.get());

          case 1: // com.sudokumaster.android.data.remote.ApiService 
